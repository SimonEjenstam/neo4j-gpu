 ...
 */
public class CountEdgeCandidatesTest extends TestCase {
    ...
    public void testReturnsTrueForCorrectCandidates1() throws Exception {
        ...
        int[] expectedEdgeCandidateCount = {
                1
        };
        ...
        CLBuffer<Integer>
                candidatesEdgeCounts = context.createIntBuffer(CLMem.Usage.Output, candidateArray.length);


        CountEdgeCandidates kernel = new CountEdgeCandidates(context);
        ...
        Pointer<Integer> outPtr = candidatesEdgeCounts.read(queue, countEdgeCandidatesEvent); // blocks until add_floats finished

        // Then
        for(int i = 0; i < candidateArray.length; i++) {
            assertEquals(expectedEdgeCandidateCount[i], (int) outPtr.get(i));
        }
    }
