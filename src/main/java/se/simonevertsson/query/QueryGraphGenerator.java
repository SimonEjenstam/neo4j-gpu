...
//    A3 ----> C4
    public static QueryGraph generateMockQueryGraph() {
        ...
        Relationship A1_B2 = A1.createRelationshipTo(B2, 1, RelationshipTypes.KNOWS);
        Relationship A1_A3 = A1.createRelationshipTo(A3, 2, RelationshipTypes.KNOWS);
        Relationship B2_A3 = B2.createRelationshipTo(A3, 3, RelationshipTypes.KNOWS);
        Relationship B2_C4 = B2.createRelationshipTo(C4, 4, RelationshipTypes.KNOWS);
        Relationship A3_C4 = A3.createRelationshipTo(C4, 5, RelationshipTypes.KNOWS);
