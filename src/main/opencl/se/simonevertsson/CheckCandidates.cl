__kernel void check_candidates(
    ...
    __global int* d_adjacency_indices,
    ...
    int data_node_count)
{
    ...
    candidate_indicators[ q_node*data_node_count + i ] = (labels_match  && q_node_degree <= (d_adjacency_indices[i+1] - d_adjacency_indices[i])) ;
}